<?php
  ...
  $result = mysqli_query($con, "SELECT * FROM marklist");
	...
	for($i=0;$i<2;$i++) {
		$mark1=$_POST['mark1'][$i];
		$mark2=$_POST['mark2'][$i];
		mysqli_query($con, "UPDATE marklist set mark1='$mark1', mark2='$mark2'");	}
	header("Location:course_marklist.php");
	}
?>
		...
		<div class="row">
			...
			<div class="col-12 col-m-12 col-sm-12">
				<div class="card1 ">
					...
					<td><input type="text" name="mark1[]" class="txtField" value="<?php echo $row[$i]['mark1']; ?>"></td>
					</tr>
					<td><label>Mark2</label></td>
					<td><input type="text" name="mark2[]" class="txtField" value="<?php echo $row[$i]['mark2']; ?>"></td>
					</tr>
					</table>
					</td>
					</tr>
