...
<body class="overlay-scrollbar">
	...
	<?php
							$query = "SELECT * FROM attendance WHERE Fac_ID LIKE '$username'  and start_date >'2020-06-04' and status like 'Accepted'  Order by start_date desc";
  ...
  <div class="row1" id="myItems">
      ...
      <div class="card">
        <div class="card-body row1">
          ...
          <h5 class="card-subtitle col-3 mb-2 "> <?php echo $row['reason']; ?></h5>
